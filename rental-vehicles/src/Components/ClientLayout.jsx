...
import { ClientRequests, UserSettings, VehicleCatalog } from '../Pages';
...
const views = {
  VehiclesCatalog: <VehicleCatalog />,
  PendingRequests: <ClientRequests type={RequestStatus[RequestStatusIndex.Pending]}/>,
  AcceptedRequests: <ClientRequests type={RequestStatus[RequestStatusIndex.Accepted]}/>,
  UserSettings: <UserSettings />
}

const MapItemsToViews = {
  '1': views.VehiclesCatalog,
